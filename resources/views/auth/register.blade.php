            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="paypal_email" class="col-md-4 col-form-label text-md-right">{{ __('Paypal Address:') }}</label>

                            <div class="col-md-6">
                                <input id="paypal_email" type="paypal_email" class="form-control @error('paypal_email') is-invalid @enderror" name="paypal_email" value="{{ old('paypal_email') }}" required autocomplete="paypal_email">
