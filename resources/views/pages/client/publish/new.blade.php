    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('client.save_publish')}}" id="publish_form"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="file" accept="image/*" id="image1"
                                       class="form-control-file  @error('image1') is-invalid @enderror"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="design_name" type="text"
                                       class="form-control @error('name') is-invalid @enderror"
                                       value="{{old('design_name')}}" name="design_name" placeholder="Design Name"
                                       autofocus>
                                @error('design_name')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="format_select" name="format" class="selectpicker" style="width: 100%"
                                        multiple>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div>
                                    ...
                                    <label for="unit_mm" style="padding-right: 20px;"
                                           class="form-check-label">{{ __('mm') }}</label>
